...
Before you run the Main.ipynb, it would be best if you changed the datapath. 


※ First, when you run the Main.ipynb file, defining the tokenizer based on the train dataset takes some time.